...
import { TrendingUp, Play, Download, Settings, FileSpreadsheet, Percent, CheckCircle, BarChart, Award } from "lucide-react";
...
export default function AnalysisPage() {
  ...
  // Form states
  const [minSupport, setMinSupport] = useState<number>(2); // Persentase (e.g. 2%)
  const [minConfidence, setMinConfidence] = useState<number>(30); // Persentase (e.g. 30%)
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3 bg-white px-4 py-2 border border-gray-100 rounded-xl shadow-sm text-xs font-semibold">
                    ...
                    <input
                      ...
                      className="w-12 text-center font-bold text-brand-teal bg-gray-50 border border-gray-200 rounded py-0.5"
                    />
                  </div>
                </div>
